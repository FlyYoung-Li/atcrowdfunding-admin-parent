    ...
    protected void initFilterBean() throws ServletException {
        synchronized (this.delegateMonitor) {
            if (this.delegate == null) {
                ...
                //按我们自己的需要重新编写,这里filter查找Bean，servlet还没加载，springMvc容器还没创建
                //只有Spirng容器，在spring容器中找不到bean，会报错，所以下面要注释
                //要在第一次发请求的时候，查springMVC容器
...
//                    WebApplicationContext wac = this.findWebApplicationContext();
                    ...
                    //这里servletName是自己在web.xml文件中，定义Filter的filter-name
